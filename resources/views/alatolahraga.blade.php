...
<head>
    ...
    <title>BAPPEDA Aceh Peralatan Olahraga</title>
...
<body>
    ...
    <div class="container mx-auto py-16">
        ...
        <h2 class="text-2xl font-bold text-green-800 mb-4 text-center">Data Visualisasi Peralatan Olah Raga</h2>
        ...
        <!-- Nama Barang Chart -->
        <div class="chart-container">
            <h3 class="text-xl font-semibold mb-2">Distribusi Barang Berdasarkan Nama Barang</h3>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var subCategoryValues = Object.values(subCategoryData);
        ...
        new Chart(subCategoryCtx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Jumlah Barang per Sub Kategori',
                    data: subCategoryValues,
                    backgroundColor: subCategoryLabels.map(() => getRandomColor()),
                    borderColor: subCategoryLabels.map(() => getRandomColor()),
                    borderWidth: 1
                }]
            },
            options: {
